...
namespace Shop.Presentation.Controllers
{
    public class AdminController : Controller
    {
        ...
        private readonly IAnalyticsService _adminService;
        private readonly IOrderService _orderService;

        public AdminController(IAccountService accountService, IAnalyticsService adminService, IOrderService orderService   )
        {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateStatus(int orderId, Status orderStatus)
        {
